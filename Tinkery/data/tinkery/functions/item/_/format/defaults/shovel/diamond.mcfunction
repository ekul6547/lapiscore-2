...
scoreboard players set #tinkery.format.base_attackdamage lapis.const 550
...
execute unless data storage tinkery:core item.format.tag.display.Name run data modify storage tinkery:core item.format.tag.display.Name set value '{"translate": "item.minecraft.diamond_shovel","italic": false}'
