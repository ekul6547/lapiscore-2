...
scoreboard players set #tinkery.format.base_attackspeed lapis.const 120
scoreboard players set #tinkery.format.base_attackdamage lapis.const 600
...
execute unless data storage tinkery:core item.format.tag.display.Name run data modify storage tinkery:core item.format.tag.display.Name set value '{"translate": "item.minecraft.netherite_pickaxe","italic": false}'
