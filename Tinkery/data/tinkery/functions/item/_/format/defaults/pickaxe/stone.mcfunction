...
scoreboard players set #tinkery.format.base_attackdamage lapis.const 300
...
execute unless data storage tinkery:core item.format.tag.display.Name run data modify storage tinkery:core item.format.tag.display.Name set value '{"translate": "item.minecraft.stone_pickaxe","italic": false}'
