data modify storage tinkery:core bookmaker.attribute.items set value ['{"text":"\\ud004","font":"lapis:icons","color":"white"}','{"text":"\\ud004","font":"lapis:icons","color":"white"}']
data modify storage tinkery:core bookmaker.attribute.title set value ''
data modify storage tinkery:core bookmaker.attribute.info set value ''
