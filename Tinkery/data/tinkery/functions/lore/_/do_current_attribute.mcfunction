...
execute if score #tinkery.lore.cmd.prevent lapis.const matches 0 if data storage tinkery:core lore.attributes[0].layerIndex run function tinkery:lore/_/test_cmd_specific
