...
execute if score #tinkery.modifier.has lapis.const matches 0 run data modify storage tinkery:core modifier.test.tool.tag.Tinkery.Attributes set from storage tinkery:core modifier.has.list
