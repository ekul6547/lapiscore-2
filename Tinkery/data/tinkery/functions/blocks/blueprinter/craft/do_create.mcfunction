...
execute if score #tinkery.blueprinter.output_match lapis.const matches 0 run function tinkery:blocks/blueprinter/craft/increase
...
function tinkery:blocks/blueprinter/craft/reduce