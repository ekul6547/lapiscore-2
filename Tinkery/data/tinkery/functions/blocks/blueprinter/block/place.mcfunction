...
data modify storage lapis:core customblock.armor_stand.CustomName set value '{"text":"Blueprint Maker","italic":false}'
data modify storage lapis:core customblock.BlockDrop set value {id:"minecraft:barrel",tag:{display:{Name:'{"italic":false,"text":"Blueprint Maker"}'}}}
...
execute unless data storage lapis:core customblock{failed:1b} at a-a-a-a-a run setblock ~ ~ ~ barrel[facing=up]{CustomName:'{"text":"Blueprint Maker","italic":false}'} destroy
