...
execute if data storage tinkery:core blueprinter.output if data block ~ ~ ~ Items[{Slot:15b}] unless data block ~ ~ ~ Items[{Slot:15b,Count:64b}] run function tinkery:blocks/blueprinter/create/test_output_matches
execute if data storage tinkery:core blueprinter.output unless data block ~ ~ ~ Items[{Slot:15b}] run function tinkery:blocks/blueprinter/create/find_create