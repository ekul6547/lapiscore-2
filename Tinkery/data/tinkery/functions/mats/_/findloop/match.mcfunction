...
data modify storage tinkery:materials find_match set from storage tinkery:materials find
execute store success score #tinkery tink.cycle.match run data modify storage tinkery:materials find_match set from storage tinkery:materials list[0].id
