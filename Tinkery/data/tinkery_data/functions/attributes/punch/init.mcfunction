...
data modify storage tinkery:recipes attributes.new.id set value "punch"
data modify storage tinkery:recipes attributes.new.name set value '{"text":"Punch","color":"light_purple"}'
...
data modify storage tinkery:core bookmaker.attribute.title set value '{"text":"Punch","color":"light_purple"}'
