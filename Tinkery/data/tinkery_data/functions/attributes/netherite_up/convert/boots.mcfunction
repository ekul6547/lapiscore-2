execute if data storage tinkery:core modifier.test.tool{id:"minecraft:leather_boots"} run scoreboard players set #tinkery.netherite_up.success lapis.const 1
execute if data storage tinkery:core modifier.test.tool{id:"minecraft:chainmail_boots"} run scoreboard players set #tinkery.netherite_up.success lapis.const 1
