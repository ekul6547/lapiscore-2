execute if data storage tinkery:core modifier.test.tool{id:"minecraft:wooden_chestplate"} run scoreboard players set #tinkery.netherite_up.success lapis.const 1
execute if data storage tinkery:core modifier.test.tool{id:"minecraft:stone_chestplate"} run scoreboard players set #tinkery.netherite_up.success lapis.const 1
