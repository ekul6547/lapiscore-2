...
execute if score #tinkery.netherite_up.success lapis.const matches 1 run data modify storage tinkery:core modifier.test.tool.tag.LapisDurability.base set value 407
...
execute if score #tinkery.netherite_up.success lapis.const matches 1 run data modify storage tinkery:core modifier.test.tool.tag.LapisDurability.base set value 592
execute if score #tinkery.netherite_up.success lapis.const matches 1 run scoreboard players set #tinkery.netherite_up.success lapis.const 2
...
execute if score #tinkery.netherite_up.success lapis.const matches 1 run data modify storage tinkery:core modifier.test.tool.tag.LapisDurability.base set value 555
execute if score #tinkery.netherite_up.success lapis.const matches 1 run scoreboard players set #tinkery.netherite_up.success lapis.const 2
...
execute if score #tinkery.netherite_up.success lapis.const matches 1 run data modify storage tinkery:core modifier.test.tool.tag.LapisDurability.base set value 481
execute if score #tinkery.netherite_up.success lapis.const matches 1 run scoreboard players set #tinkery.netherite_up.success lapis.const 2