...
data modify storage tinkery:recipes attributes.new.id set value "movement_speed"
...
data modify storage tinkery:core bookmaker.attribute.title set value '{"text":"Speedy (Movement)","color":"dark_red"}'
data modify storage tinkery:core bookmaker.attribute.info set value '{"text":"Faster Movement."}'
