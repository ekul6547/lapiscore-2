...
data modify storage tinkery:recipes attributes.new.name set value '{"text":"Night Vision","color":"dark_gray"}'
...
data modify storage tinkery:core bookmaker.attribute.title set value '{"text":"Night Vision","color":"dark_gray"}'
