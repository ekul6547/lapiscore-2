...
data modify storage tinkery:core bookmaker.blueprint.recipe[0] set value '{"text":"\\ud426","font":"lapis:icons","color":"white","hoverEvent":{"action":"show_text","value":["",{"translate": "item.minecraft.wooden_hoe","color":"white"}]}}]}'
