...
data modify storage tinkery:core blueprints.new.id set value "trident"
data modify storage tinkery:core blueprints.new.name set value '{"text":"Trident Blueprint","italic":false}'
data modify storage tinkery:core blueprints.new.CustomModelData set value 4041012
...
data modify storage tinkery:core bookmaker.blueprint.title set value '{"text":"Trident Blueprint","color":"blue"}'
data modify storage tinkery:core bookmaker.blueprint.recipe[0] set value '{"text":"\\ud3e5","font":"lapis:icons","color":"white","hoverEvent":{"action":"show_text","value":["",{"translate": "item.minecraft.prismarine_crystals","color":"white"}]}}]}'
data modify storage tinkery:core bookmaker.blueprint.output set value '["",{"text":"\\ud100","font":"tinkery:icons","color":"white","hoverEvent":{"action":"show_text","value":["",{"text":"Trident Blueprint","color":"white"}]}},{"text":"","color":"black"}]'
data modify block 20000002 1 20000000 Text1 set value '["",{"nbt":"bookmaker.blueprint.title","storage":"tinkery:core","interpret":true,"underlined": true},{"text":"\\n\\n\\ud001","font":"lapis:icons","color":"white"},{"nbt":"bookmaker.blueprint.recipe[0]","storage":"tinkery:core","interpret":true},{"nbt":"bookmaker.blueprint.recipe[1]","storage":"tinkery:core","interpret":true},{"nbt":"bookmaker.blueprint.right","storage":"tinkery:core","interpret":true},{"nbt":"bookmaker.blueprint.output","storage":"tinkery:core","interpret":true},{"text":"\\n\\n"},{"nbt":"bookmaker.blueprint.below","storage":"tinkery:core","interpret":true},{"text":"Constructor Usage","interpret":true,"underlined": true},{"text":"\\n\\nPlace a trident in the single slot.\\n\\n\\n"},{"text":"\\ud004\\ud419","font":"lapis:icons","color":"white","hoverEvent":{"action":"show_text","value":["",{"text":"Trident","color":"white"}]}}]'
