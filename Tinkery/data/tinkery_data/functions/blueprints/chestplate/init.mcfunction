...
data modify storage tinkery:core bookmaker.blueprint.recipe[0] set value '{"text":"\\ud48e","font":"lapis:icons","color":"white","hoverEvent":{"action":"show_text","value":["",{"translate": "item.minecraft.leather_chestplate","color":"white"}]}}]}'
