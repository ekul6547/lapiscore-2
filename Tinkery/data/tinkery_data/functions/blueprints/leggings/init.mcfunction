...
data modify storage tinkery:core bookmaker.blueprint.recipe[0] set value '{"text":"\\ud491","font":"lapis:icons","color":"white","hoverEvent":{"action":"show_text","value":["",{"text":"Leather Pants","color":"white"}]}}]}'
