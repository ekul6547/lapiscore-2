...
execute if entity @s[tag=lapis.block.break] run function lapis:custom_blocks/test_should_autobreak
execute if entity @s[tag=lapis.block.autobreak] run function lapis:custom_blocks/test_should_autobreak
execute if entity @s[tag=lapis.block,tag=!lapis.block.break] run function #lapis:custom_blocks/tick