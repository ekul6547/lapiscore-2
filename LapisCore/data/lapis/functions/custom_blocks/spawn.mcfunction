summon armor_stand ~ ~ ~ {Invulnerable:1b,NoGravity:1b,Marker:1b,NoBasePlate:1b,Invisible:1b,Fire:32676s,DisabledSlots:2039583,Tags:["lapis.block","lapis.block.new"],Small:1b}
