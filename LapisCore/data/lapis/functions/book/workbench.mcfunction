...
data modify storage lapis:core bookmaker.craft.recipe[1] set value '{"text":"\\ud0fd","font":"lapis:icons","color":"white","hoverEvent":{"action":"show_text","value":["",{"translate": "block.minecraft.crafting_table","color":"white"}]}}]}'
